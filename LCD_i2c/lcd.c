...
// Puntero a I2C usado
static i2c_master_dev_handle_t  *lcd_i2c;
...
void i2c_write_byte(uint8_t val) {
    ...
    i2c_master_transmit(lcd_i2c, &val, 1 , 1000);
}
...
#define DELAY_US 10 / portTICK_PERIOD_MS
    vTaskDelay(DELAY_US);
...
*/
void lcd_init(i2c_master_dev_handle_t *i2c, uint8_t address) {
    // Guardo el I2C usado
    lcd_i2c = i2c;
